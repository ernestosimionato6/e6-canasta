...
android {
    defaultConfig {
        applicationId = "ven.task.apps.t2do"
        versionCode = 1
    ...
    namespace = "ven.task.apps.t2do"
}

dependencies {

    implementation(project(":e6:task:core:ui"))
    implementation(project(":e6:task:core:data"))
    implementation(project(":e6:task:core:model"))
